...
## Overview  
This is a full‑stack web application that allows users to create, manage, and share shopping lists. Designed to demonstrate end‑to‑end development, it features a modern front‑end UI, back‑end REST API, and persistent storage.
